...
stest: stest.o struct.o
	gcc -g stest.o struct.o -lreadline -ltermcap -o stest

stest.o: stest.c struct.h
	gcc -g -c stest.c

stestdebug: stestdebug.o struct.o
	gcc -g stestdebug.o struct.o -lreadline -ltermcap -o stestdebug

stestdebug.o: stest.c struct.h 
	gcc -g -c stest.c -o stestdebug.o -DDEBUG

employee_read_binary: struct.o employee_read_binary.o
	gcc -g -lreadline -ltermcap struct.o employee_read_binary.o -o employee_read_binary
...
employee_write_binary: struct.o employee_write_binary.o
	gcc -g -lreadline -ltermcap struct.o employee_write_binary.o -o employee_write_binary
...
employee_write_text: struct.o employee_write_text.o
	gcc -g -lreadline -ltermcap struct.o employee_write_text.o -o employee_write_text
...
employee_read_file: struct.o employee_read_file.o
	gcc -g -lreadline -ltermcap employee_read_file.o struct.o -o employee_read_file
